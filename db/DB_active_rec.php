...
class CI_DB_active_record extends CI_DB_driver {
	...
	//From: http://stackoverflow.com/questions/2040655/union-query-with-codeigniters-active-record-pattern/14270008#14658160
	var $unions = array();
	 ...
	 * @return	object
	 *
	 * Altered according to http://ellislab.com/forums/viewthread/219734/#1012948 -- NK, 2014-01-30
	 */
	...
	*/
    ...
    public function union()
    {
		...
		$sql = preg_replace('/FROM \(([A-Za-z0-9`,_ ]*)\)/', 'FROM $1', $sql);
        $result = $this->query($sql);
        $this->union_flush();
        return $result;
    }
